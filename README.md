...
## 🌌 Overview
This repository contains the institutional-grade protein folding engine and interactive demonstrations for the **Nexus Resonance Codex (NRC)**. Utilizing the **Trageser Tensor Theorem (TTT)** and high-dimensional **φ-spiral manifolds**, our platform achieves near-instantaneous structural prediction for intrinsically disordered proteins (IDPs) and complex globular targets.

### 🧬 Key Features
- **Multi-Modal Folding Locus**: Toggle between **NRC Pure Math**, **ESMFold (AI Only)**, and **Hybrid (AI + NRC)** modes.
- **Institutional IDP Library**: Curated set of 100+ high-impact disordered proteins (sourced from DisProt) linked to neurodegeneration and cancer.
- **256D φ-Manifold Projection**: Real-time visualization of structural resonance in non-Euclidean space.
- **Sovereign Mutation Lab**: Simulate single-point mutations and predict ΔΔG resonance shifts.
- **Institutional Research Export**: Automated generation of PDB, CSV, and JSON metadata packages.
...
- `nrc_engine.py`: The 736D phi-lattice engine for deterministic folding.
- `biophysics.py`: Institutional biophysical profile calculation (Hydropathy, Charge, Entropy).
- `protein_library.py`: Modular library of 100+ medically significant IDP sequences.

## 🏛 Mathematical Foundation
The NRC folding backend operates on the principle of **Lattice Resonance**. By projecting amino acid sequences into a 256D φ-spiral manifold, we can solve structural topology as a harmonic resonance problem rather than a stochastic optimization.
