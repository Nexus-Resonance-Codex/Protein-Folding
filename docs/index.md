...
<div class="hero-wrapper" style="position: relative; border-radius: 40px; overflow: hidden; border: 1px solid rgba(0, 240, 255, 0.25); background: radial-gradient(circle at center, #0a0a18 0%, #000 100%); box-shadow: 0 50px 120px rgba(0,0,0,1); margin: 3rem 0;">
  ...
  <div style="position: absolute; bottom: 3rem; right: 3rem; background: rgba(5, 5, 20, 0.9); backdrop-filter: blur(25px); padding: 2.8rem; border-radius: 35px; border: 1px solid rgba(255, 255, 255, 0.12); width: 360px; box-shadow: 0 30px 60px rgba(0,0,0,0.6);">
    ...
    <div style="font-size: 1rem; color: #fff; text-align: center; font-weight: 800; text-transform: uppercase;">999.8x SPEEDUP VERIFIED</div>
  </div>
</div>

<div style="display: flex; gap: 2.5rem; justify-content: center; margin-bottom: 6rem;">
  <a href="demos/protein-folding-showcase.html" class="md-button md-button--primary" style="padding: 1.6rem 4.5rem; font-size: 1.4rem; border-radius: 24px; background: linear-gradient(135deg, #FFD700, #00F0FF); color: #000; font-weight: 900; box-shadow: 0 15px 50px rgba(0, 240, 255, 0.45);">🚀 Try Live Folding Now</a>
  <a href="https://github.com/Nexus-Resonance-Codex/Protein-Folding/blob/master/.github/prompts/folding-verifier.prompt.yml" class="md-button" style="padding: 1.6rem 4.5rem; font-size: 1.4rem; border-radius: 24px; border: 2px solid rgba(0, 240, 255, 0.7); color: #00F0FF; font-weight: 800;">🤖 Test on GitHub Models</a>
</div>
...
<div align="center" style="margin-top: 7rem; padding-bottom: 5rem;">
  <p style="font-size: 1.2rem; font-style: italic; color: #666; max-width: 650px;">
    "By mastering the geometry of life, we ensure the survival of those we love."
  </p>
  <p style="font-weight: 900; color: #fff; margin-top: 1.2rem; letter-spacing: 3px; text-transform: uppercase;">
