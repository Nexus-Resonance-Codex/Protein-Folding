...
\begin{tcolorbox}[
	...
	Attention logits are multiplied across the Hodge-Phi-Torsion Attention using $\phi$ torsion paths natively. This extracts higher-dimensional topological correlations between tokens that standard dot products are mathematically blind to.
\end{tcolorbox}
