...
class NRCForcefield:
    ...
    def optimize(self, max_iter=500):
        res = minimize(self.energy_and_gradient, self.x0, method="L-BFGS-B", jac=True, options={"maxiter": max_iter, "gtol": 1e-5})
        self.x0 = res.x
    ...
    def generate_all_atom(self, ca_coords):
        ...
        return {"coords": np.array(all_coords), "atom_types": atom_types, "res_indices": res_indices, "res_names": res_names}
